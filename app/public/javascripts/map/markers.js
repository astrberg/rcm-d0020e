...
function addStationToLayer(station, layerNumber){
    ...
    //     if(markerDiv != null) {
    //         for(let i = 0; i < 4; i++) {
    //             markerDiv.rows[i + 2].cells[1].innerHTML = latestWeatherData[0][0][data[i]] + dataText[i];
    //         }
    //         markerDiv.rows[6].cells[1].innerHTML =  windDirection(latestWeatherData[0][0][data[4]]);
    //     }   
